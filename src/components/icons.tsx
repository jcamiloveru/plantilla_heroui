...
export const Logo: React.FC<IconSvgProps> = ({ size = 36, height, width, ...props }) => {
...
export const DiscordIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  ...
  return (
    <svg height={size || height} viewBox="0 0 24 24" width={size || width} {...rest}>
      <path
